...
import {
  tableCellViewerChartConfig,
  tableCellViewerChartData,
} from '@/components/pages/homePage/dataTable/tableCellViewer/TableCellViewer.constants';
    ...
    <Drawer direction={isMobile ? 'bottom' : 'right'}>
      ...
      <DrawerContent>
        ...
        <div className="flex flex-col gap-4 overflow-y-auto px-4 text-sm">
          {!isMobile && (
            <>
              <ChartContainer config={tableCellViewerChartConfig}>
                <AreaChart
                  accessibilityLayer
                  data={tableCellViewerChartData}
                  margin={{
                    left: 0,
                    right: 10,
                  }}
